Hi I have 0 idea what I'm talking about when it comes to markup :))

This is a small tattoo mod I made for my server a while ago and we have decided to release it for everyone to use, 
...
This mod and content within is only allowed to be published under my steam account.
YOU ARE NOT ALLOWED TO REPACK/REPUBLISH/REKEY ANY CONTENT FROM THIS PACK.
